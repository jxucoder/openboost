...
Independent CPU example package: `from bounded_leaves import BoundedNewton`.
...
backend. Bound must be finite and positive; the declared capability is CPU only.
...
GPU package verification remains pending.
