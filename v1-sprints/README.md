...
shared training preparation. The latest full regression records 846 passes;
...
window. Next hoist invariant row hashing and verify unchanged candidates/results.
