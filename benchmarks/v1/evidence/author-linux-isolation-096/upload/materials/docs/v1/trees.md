...
Newton adapters and callbacks are described in multiclass and vectors (outside this packet).
...
row_leaf and leaf_context arguments described in quantile leaves (outside this packet).
...
[squared](squared.md) and Normal (outside this packet) recipes. Artifacts
...
or CatBoost feature/quality parity. Categorical support (outside this packet) uses the same three policies.
