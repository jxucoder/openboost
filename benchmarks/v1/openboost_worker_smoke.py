"""Bounded current A1/A2/A3/A5/A6/A7/A11 worker integration on all five frozen folds."""
...
def run(directory, applications=("A1", "A6", "A11")):
    if (
        ...
        or set(applications) - {"A1", "A2", "A3", "A5", "A6", "A7", "A11"}
    ):
    ...
    report = dict(
        scope="Current A1/A2/A3/A5/A6/A7/A11 real-data validation plumbing only; four rounds, no test scores, quality or performance claim",
            ...
            if record["status"] == "pass":
                try:
                    ...
                    with (
                        ...
                        expected_width = (
                            () if app in {"A1", "A2", "A7"} else (7,) if app == "A3" else (2,)
                        )
                        if app == "A5":
                            expected_width = (3,)
                        if app == "A6":
