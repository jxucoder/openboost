...
状态：**F0.1 任务卡已完成；下一步 F0.2；新 v1 实现与 eval 尚未执行**。这里的 v1 是本次产品/架构目标，
...
F0.1 任务规格已交付；接下来从 F0.2 独立参考程序开始，按依赖与证据门槛推进。
...
> 读取 F0.1 任务卡，执行 F0.2：在 tests/v1/reference/ 按任务卡建立独立 NumPy
